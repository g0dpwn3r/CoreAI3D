...
#ifndef GOOGLE_PROTOBUF_INCLUDED_CoreAI3D_2fcloud_5fspeech_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_CoreAI3D_2fcloud_5fspeech_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_CoreAI3D_2fcloud_5fspeech_2eproto;
namespace google {
namespace cloud {
namespace speech {
namespace v1 {
...
template<> ::google::cloud::speech::v1::SpeechAdaptationInfo* Arena::CreateMaybeMessage<::google::cloud::speech::v1::SpeechAdaptationInfo>(Arena*);
...
template<> ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* Arena::CreateMaybeMessage<::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout>(Arena*);
...
constexpr StreamingRecognizeResponse_SpeechEventType StreamingRecognizeResponse_SpeechEventType_SpeechEventType_MAX = StreamingRecognizeResponse_SpeechEventType_SPEECH_ACTIVITY_TIMEOUT;
...
class StreamingRecognitionConfig_VoiceActivityTimeout final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.speech.v1.StreamingRecognitionConfig.VoiceActivityTimeout) */ {
 public:
  inline StreamingRecognitionConfig_VoiceActivityTimeout() : StreamingRecognitionConfig_VoiceActivityTimeout(nullptr) {}
  ~StreamingRecognitionConfig_VoiceActivityTimeout() override;
  explicit constexpr StreamingRecognitionConfig_VoiceActivityTimeout(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  StreamingRecognitionConfig_VoiceActivityTimeout(const StreamingRecognitionConfig_VoiceActivityTimeout& from);
  StreamingRecognitionConfig_VoiceActivityTimeout(StreamingRecognitionConfig_VoiceActivityTimeout&& from) noexcept
  ...
  friend void swap(StreamingRecognitionConfig_VoiceActivityTimeout& a, StreamingRecognitionConfig_VoiceActivityTimeout& b) {
    a.Swap(&b);
  }
  ...
  StreamingRecognitionConfig_VoiceActivityTimeout* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StreamingRecognitionConfig_VoiceActivityTimeout>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const StreamingRecognitionConfig_VoiceActivityTimeout& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const StreamingRecognitionConfig_VoiceActivityTimeout& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  protected:
  explicit StreamingRecognitionConfig_VoiceActivityTimeout(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
class StreamingRecognitionConfig final :
 ...
 public:
  ...
  typedef StreamingRecognitionConfig_VoiceActivityTimeout VoiceActivityTimeout;
  ...
  void set_allocated_voice_activity_timeout(::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* voice_activity_timeout);
  private:
  ...
  void unsafe_arena_set_allocated_voice_activity_timeout(
      ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* voice_activity_timeout);
...
class RecognitionConfig final :
 ...
 public:
  ...
  private:
  bool _internal_has_transcript_normalization() const;
  public:
  ...
  void set_allocated_transcript_normalization(::google::cloud::speech::v1::TranscriptNormalization* transcript_normalization);
  private:
  ...
  public:
  void unsafe_arena_set_allocated_transcript_normalization(
      ::google::cloud::speech::v1::TranscriptNormalization* transcript_normalization);
...
class RecognizeResponse final :
 ...
 public:
  ...
  private:
  bool _internal_has_speech_adaptation_info() const;
  public:
  ...
  void set_allocated_speech_adaptation_info(::google::cloud::speech::v1::SpeechAdaptationInfo* speech_adaptation_info);
  private:
  ...
  public:
  void unsafe_arena_set_allocated_speech_adaptation_info(
      ::google::cloud::speech::v1::SpeechAdaptationInfo* speech_adaptation_info);
...
class StreamingRecognizeResponse final :
 ...
 public:
  ...
  static constexpr SpeechEventType SPEECH_ACTIVITY_TIMEOUT =
    StreamingRecognizeResponse_SpeechEventType_SPEECH_ACTIVITY_TIMEOUT;
  ...
  private:
  bool _internal_has_speech_event_time() const;
  public:
  void clear_speech_event_time();
  const ::PROTOBUF_NAMESPACE_ID::Duration& speech_event_time() const;
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Duration* release_speech_event_time();
  ::PROTOBUF_NAMESPACE_ID::Duration* mutable_speech_event_time();
  void set_allocated_speech_event_time(::PROTOBUF_NAMESPACE_ID::Duration* speech_event_time);
  private:
  const ::PROTOBUF_NAMESPACE_ID::Duration& _internal_speech_event_time() const;
  ::PROTOBUF_NAMESPACE_ID::Duration* _internal_mutable_speech_event_time();
  public:
  void unsafe_arena_set_allocated_speech_event_time(
      ::PROTOBUF_NAMESPACE_ID::Duration* speech_event_time);
  ::PROTOBUF_NAMESPACE_ID::Duration* unsafe_arena_release_speech_event_time();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::Duration* total_billed_time_;
  ::PROTOBUF_NAMESPACE_ID::Duration* speech_event_time_;
  ::google::cloud::speech::v1::SpeechAdaptationInfo* speech_adaptation_info_;
...
class SpeechAdaptationInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.speech.v1.SpeechAdaptationInfo) */ {
 public:
  inline SpeechAdaptationInfo() : SpeechAdaptationInfo(nullptr) {}
  ~SpeechAdaptationInfo() override;
  explicit constexpr SpeechAdaptationInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SpeechAdaptationInfo(const SpeechAdaptationInfo& from);
  SpeechAdaptationInfo(SpeechAdaptationInfo&& from) noexcept
  ...
  friend void swap(SpeechAdaptationInfo& a, SpeechAdaptationInfo& b) {
    a.Swap(&b);
  }
  ...
  SpeechAdaptationInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SpeechAdaptationInfo>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SpeechAdaptationInfo& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const SpeechAdaptationInfo& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  protected:
  explicit SpeechAdaptationInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_timeout_message(ArgT0&& arg0, ArgT... args);
  std::string* mutable_timeout_message();
  PROTOBUF_NODISCARD std::string* release_timeout_message();
  void set_allocated_timeout_message(std::string* timeout_message);
  private:
  const std::string& _internal_timeout_message() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_timeout_message(const std::string& value);
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr timeout_message_;
...
inline void RecognizeRequest::set_allocated_config(::google::cloud::speech::v1::RecognitionConfig* config) {
  ...
  if (config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::speech::v1::RecognitionConfig>::GetOwningArena(config);
...
inline void RecognizeRequest::set_allocated_audio(::google::cloud::speech::v1::RecognitionAudio* audio) {
  ...
  if (audio) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::speech::v1::RecognitionAudio>::GetOwningArena(audio);
    if (message_arena != submessage_arena) {
...
inline void LongRunningRecognizeRequest::set_allocated_output_config(::google::cloud::speech::v1::TranscriptOutputConfig* output_config) {
  ...
  if (output_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::speech::v1::TranscriptOutputConfig>::GetOwningArena(output_config);
    if (message_arena != submessage_arena) {
...
inline void TranscriptOutputConfig::set_gcs_uri(ArgT0&& arg0, ArgT... args) {
  ...
  output_type_.gcs_uri_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TranscriptOutputConfig::_internal_set_gcs_uri(const std::string& value) {
  ...
  output_type_.gcs_uri_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
...
inline std::string* TranscriptOutputConfig::release_gcs_uri() {
  ...
  if (_internal_has_gcs_uri()) {
    clear_has_output_type();
    return output_type_.gcs_uri_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
...
inline ::google::cloud::speech::v1::StreamingRecognitionConfig* StreamingRecognizeRequest::_internal_mutable_streaming_config() {
  if (!_internal_has_streaming_config()) {
    clear_streaming_request();
    set_has_streaming_config();
    streaming_request_.streaming_config_ = CreateMaybeMessage< ::google::cloud::speech::v1::StreamingRecognitionConfig >(GetArenaForAllocation());
  }
...
inline void StreamingRecognizeRequest::set_audio_content(ArgT0&& arg0, ArgT... args) {
  ...
  streaming_request_.audio_content_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void StreamingRecognizeRequest::_internal_set_audio_content(const std::string& value) {
  ...
  streaming_request_.audio_content_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
...
inline std::string* StreamingRecognizeRequest::release_audio_content() {
  ...
  if (_internal_has_audio_content()) {
    clear_has_streaming_request();
    return streaming_request_.audio_content_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
...
// .google.protobuf.Duration speech_start_timeout = 1;
inline bool StreamingRecognitionConfig_VoiceActivityTimeout::_internal_has_speech_start_timeout() const {
  return this != internal_default_instance() && speech_start_timeout_ != nullptr;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Duration& StreamingRecognitionConfig_VoiceActivityTimeout::_internal_speech_start_timeout() const {
  const ::PROTOBUF_NAMESPACE_ID::Duration* p = speech_start_timeout_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Duration&>(
      ::PROTOBUF_NAMESPACE_ID::_Duration_default_instance_);
}
inline const ::PROTOBUF_NAMESPACE_ID::Duration& StreamingRecognitionConfig_VoiceActivityTimeout::speech_start_timeout() const {
...
inline void StreamingRecognitionConfig_VoiceActivityTimeout::unsafe_arena_set_allocated_speech_start_timeout(
    ::PROTOBUF_NAMESPACE_ID::Duration* speech_start_timeout) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_start_timeout_);
  }
  speech_start_timeout_ = speech_start_timeout;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::release_speech_start_timeout() {
  
  ::PROTOBUF_NAMESPACE_ID::Duration* temp = speech_start_timeout_;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::unsafe_arena_release_speech_start_timeout() {
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::_internal_mutable_speech_start_timeout() {
  
  if (speech_start_timeout_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Duration>(GetArenaForAllocation());
    speech_start_timeout_ = p;
  }
  return speech_start_timeout_;
}
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::mutable_speech_start_timeout() {
...
inline void StreamingRecognitionConfig_VoiceActivityTimeout::set_allocated_speech_start_timeout(::PROTOBUF_NAMESPACE_ID::Duration* speech_start_timeout) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_start_timeout_);
  }
...
// .google.protobuf.Duration speech_end_timeout = 2;
inline bool StreamingRecognitionConfig_VoiceActivityTimeout::_internal_has_speech_end_timeout() const {
  return this != internal_default_instance() && speech_end_timeout_ != nullptr;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Duration& StreamingRecognitionConfig_VoiceActivityTimeout::_internal_speech_end_timeout() const {
  const ::PROTOBUF_NAMESPACE_ID::Duration* p = speech_end_timeout_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Duration&>(
      ::PROTOBUF_NAMESPACE_ID::_Duration_default_instance_);
}
inline const ::PROTOBUF_NAMESPACE_ID::Duration& StreamingRecognitionConfig_VoiceActivityTimeout::speech_end_timeout() const {
...
inline void StreamingRecognitionConfig_VoiceActivityTimeout::unsafe_arena_set_allocated_speech_end_timeout(
    ::PROTOBUF_NAMESPACE_ID::Duration* speech_end_timeout) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_end_timeout_);
  }
  speech_end_timeout_ = speech_end_timeout;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::release_speech_end_timeout() {
  
  ::PROTOBUF_NAMESPACE_ID::Duration* temp = speech_end_timeout_;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::unsafe_arena_release_speech_end_timeout() {
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::_internal_mutable_speech_end_timeout() {
  
  if (speech_end_timeout_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Duration>(GetArenaForAllocation());
    speech_end_timeout_ = p;
  }
  return speech_end_timeout_;
}
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionConfig_VoiceActivityTimeout::mutable_speech_end_timeout() {
...
inline void StreamingRecognitionConfig_VoiceActivityTimeout::set_allocated_speech_end_timeout(::PROTOBUF_NAMESPACE_ID::Duration* speech_end_timeout) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_end_timeout_);
  }
...
inline bool StreamingRecognitionConfig::_internal_enable_voice_activity_events() const {
  return enable_voice_activity_events_;
}
...
inline void StreamingRecognitionConfig::_internal_set_enable_voice_activity_events(bool value) {
  ...
  enable_voice_activity_events_ = value;
}
...
// .google.cloud.speech.v1.StreamingRecognitionConfig.VoiceActivityTimeout voice_activity_timeout = 6;
inline bool StreamingRecognitionConfig::_internal_has_voice_activity_timeout() const {
  return this != internal_default_instance() && voice_activity_timeout_ != nullptr;
}
...
inline const ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout& StreamingRecognitionConfig::_internal_voice_activity_timeout() const {
  const ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* p = voice_activity_timeout_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout&>(
      ::google::cloud::speech::v1::_StreamingRecognitionConfig_VoiceActivityTimeout_default_instance_);
}
inline const ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout& StreamingRecognitionConfig::voice_activity_timeout() const {
...
inline void StreamingRecognitionConfig::unsafe_arena_set_allocated_voice_activity_timeout(
    ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* voice_activity_timeout) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(voice_activity_timeout_);
  }
  voice_activity_timeout_ = voice_activity_timeout;
...
inline ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* StreamingRecognitionConfig::release_voice_activity_timeout() {
  ...
  ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* temp = voice_activity_timeout_;
  voice_activity_timeout_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* StreamingRecognitionConfig::_internal_mutable_voice_activity_timeout() {
  ...
  if (voice_activity_timeout_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout>(GetArenaForAllocation());
    voice_activity_timeout_ = p;
  }
  return voice_activity_timeout_;
}
inline ::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* StreamingRecognitionConfig::mutable_voice_activity_timeout() {
...
inline void StreamingRecognitionConfig::set_allocated_voice_activity_timeout(::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout* voice_activity_timeout) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete voice_activity_timeout_;
  }
  if (voice_activity_timeout) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::speech::v1::StreamingRecognitionConfig_VoiceActivityTimeout>::GetOwningArena(voice_activity_timeout);
    if (message_arena != submessage_arena) {
...
// .google.cloud.speech.v1.TranscriptNormalization transcript_normalization = 24 [(.google.api.field_behavior) = OPTIONAL];
inline bool RecognitionConfig::_internal_has_transcript_normalization() const {
  return this != internal_default_instance() && transcript_normalization_ != nullptr;
}
inline bool RecognitionConfig::has_transcript_normalization() const {
  return _internal_has_transcript_normalization();
}
inline const ::google::cloud::speech::v1::TranscriptNormalization& RecognitionConfig::_internal_transcript_normalization() const {
  const ::google::cloud::speech::v1::TranscriptNormalization* p = transcript_normalization_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::speech::v1::TranscriptNormalization&>(
      ::google::cloud::speech::v1::_TranscriptNormalization_default_instance_);
}
inline const ::google::cloud::speech::v1::TranscriptNormalization& RecognitionConfig::transcript_normalization() const {
...
inline void RecognitionConfig::unsafe_arena_set_allocated_transcript_normalization(
    ::google::cloud::speech::v1::TranscriptNormalization* transcript_normalization) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(transcript_normalization_);
  }
  transcript_normalization_ = transcript_normalization;
  if (transcript_normalization) {
...
inline ::google::cloud::speech::v1::TranscriptNormalization* RecognitionConfig::release_transcript_normalization() {
  ...
  ::google::cloud::speech::v1::TranscriptNormalization* temp = transcript_normalization_;
...
inline ::google::cloud::speech::v1::TranscriptNormalization* RecognitionConfig::_internal_mutable_transcript_normalization() {
  ...
  if (transcript_normalization_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::speech::v1::TranscriptNormalization>(GetArenaForAllocation());
    transcript_normalization_ = p;
  }
  return transcript_normalization_;
}
inline ::google::cloud::speech::v1::TranscriptNormalization* RecognitionConfig::mutable_transcript_normalization() {
...
inline void RecognitionConfig::set_allocated_transcript_normalization(::google::cloud::speech::v1::TranscriptNormalization* transcript_normalization) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(transcript_normalization_);
  }
  if (transcript_normalization) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(transcript_normalization));
    if (message_arena != submessage_arena) {
      transcript_normalization = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, transcript_normalization, submessage_arena);
    }
...
inline void RecognitionConfig::set_allocated_diarization_config(::google::cloud::speech::v1::SpeakerDiarizationConfig* diarization_config) {
  ...
  if (diarization_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::speech::v1::SpeakerDiarizationConfig>::GetOwningArena(diarization_config);
    if (message_arena != submessage_arena) {
...
inline void RecognitionConfig::set_allocated_metadata(::google::cloud::speech::v1::RecognitionMetadata* metadata) {
  ...
  if (metadata) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::speech::v1::RecognitionMetadata>::GetOwningArena(metadata);
    if (message_arena != submessage_arena) {
...
void RecognitionMetadata::set_recording_device_name(ArgT0&& arg0, ArgT... args) {
 ...
 recording_device_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RecognitionMetadata::_internal_set_recording_device_name(const std::string& value) {
  ...
  recording_device_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RecognitionMetadata::_internal_mutable_recording_device_name() {
  
  return recording_device_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RecognitionMetadata::release_recording_device_name() {
  ...
  return recording_device_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void RecognitionMetadata::set_allocated_recording_device_name(std::string* recording_device_name) {
  ...
  recording_device_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), recording_device_name,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (recording_device_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
void RecognitionMetadata::set_original_mime_type(ArgT0&& arg0, ArgT... args) {
 ...
 original_mime_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RecognitionMetadata::_internal_set_original_mime_type(const std::string& value) {
  ...
  original_mime_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RecognitionMetadata::_internal_mutable_original_mime_type() {
  
  return original_mime_type_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RecognitionMetadata::release_original_mime_type() {
  ...
  return original_mime_type_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void RecognitionMetadata::set_allocated_original_mime_type(std::string* original_mime_type) {
  ...
  original_mime_type_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), original_mime_type,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (original_mime_type_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
void RecognitionMetadata::set_audio_topic(ArgT0&& arg0, ArgT... args) {
 ...
 audio_topic_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RecognitionMetadata::_internal_set_audio_topic(const std::string& value) {
  ...
  audio_topic_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RecognitionMetadata::_internal_mutable_audio_topic() {
  
  return audio_topic_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RecognitionMetadata::release_audio_topic() {
  ...
  return audio_topic_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void RecognitionMetadata::set_allocated_audio_topic(std::string* audio_topic) {
  ...
  audio_topic_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), audio_topic,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (audio_topic_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void RecognitionAudio::set_content(ArgT0&& arg0, ArgT... args) {
  ...
  audio_source_.content_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RecognitionAudio::_internal_set_content(const std::string& value) {
  ...
  audio_source_.content_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
...
inline std::string* RecognitionAudio::release_content() {
  ...
  if (_internal_has_content()) {
    clear_has_audio_source();
    return audio_source_.content_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
...
inline void RecognitionAudio::set_uri(ArgT0&& arg0, ArgT... args) {
  ...
  audio_source_.uri_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RecognitionAudio::_internal_set_uri(const std::string& value) {
  ...
  audio_source_.uri_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
...
inline std::string* RecognitionAudio::release_uri() {
  ...
  if (_internal_has_uri()) {
    clear_has_audio_source();
    return audio_source_.uri_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
...
// .google.cloud.speech.v1.SpeechAdaptationInfo speech_adaptation_info = 7;
inline bool RecognizeResponse::_internal_has_speech_adaptation_info() const {
  return this != internal_default_instance() && speech_adaptation_info_ != nullptr;
}
inline bool RecognizeResponse::has_speech_adaptation_info() const {
  return _internal_has_speech_adaptation_info();
}
...
inline const ::google::cloud::speech::v1::SpeechAdaptationInfo& RecognizeResponse::_internal_speech_adaptation_info() const {
  const ::google::cloud::speech::v1::SpeechAdaptationInfo* p = speech_adaptation_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::speech::v1::SpeechAdaptationInfo&>(
      ::google::cloud::speech::v1::_SpeechAdaptationInfo_default_instance_);
}
inline const ::google::cloud::speech::v1::SpeechAdaptationInfo& RecognizeResponse::speech_adaptation_info() const {
...
inline void RecognizeResponse::unsafe_arena_set_allocated_speech_adaptation_info(
    ::google::cloud::speech::v1::SpeechAdaptationInfo* speech_adaptation_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_adaptation_info_);
  }
  speech_adaptation_info_ = speech_adaptation_info;
  if (speech_adaptation_info) {
...
inline ::google::cloud::speech::v1::SpeechAdaptationInfo* RecognizeResponse::release_speech_adaptation_info() {
  ...
  ::google::cloud::speech::v1::SpeechAdaptationInfo* temp = speech_adaptation_info_;
  speech_adaptation_info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::google::cloud::speech::v1::SpeechAdaptationInfo* RecognizeResponse::_internal_mutable_speech_adaptation_info() {
  ...
  if (speech_adaptation_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::speech::v1::SpeechAdaptationInfo>(GetArenaForAllocation());
    speech_adaptation_info_ = p;
  }
  return speech_adaptation_info_;
}
inline ::google::cloud::speech::v1::SpeechAdaptationInfo* RecognizeResponse::mutable_speech_adaptation_info() {
...
inline void RecognizeResponse::set_allocated_speech_adaptation_info(::google::cloud::speech::v1::SpeechAdaptationInfo* speech_adaptation_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete speech_adaptation_info_;
  }
  if (speech_adaptation_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::speech::v1::SpeechAdaptationInfo>::GetOwningArena(speech_adaptation_info);
    if (message_arena != submessage_arena) {
      speech_adaptation_info = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, speech_adaptation_info, submessage_arena);
    }
...
// .google.cloud.speech.v1.SpeechAdaptationInfo speech_adaptation_info = 8;
inline bool LongRunningRecognizeResponse::_internal_has_speech_adaptation_info() const {
  return this != internal_default_instance() && speech_adaptation_info_ != nullptr;
}
...
inline const ::google::cloud::speech::v1::SpeechAdaptationInfo& LongRunningRecognizeResponse::speech_adaptation_info() const {
...
inline ::google::cloud::speech::v1::SpeechAdaptationInfo* LongRunningRecognizeResponse::mutable_speech_adaptation_info() {
  ::google::cloud::speech::v1::SpeechAdaptationInfo* _msg = _internal_mutable_speech_adaptation_info();
  // @@protoc_insertion_point(field_mutable:google.cloud.speech.v1.LongRunningRecognizeResponse.speech_adaptation_info)
  return _msg;
}
inline void LongRunningRecognizeResponse::set_allocated_speech_adaptation_info(::google::cloud::speech::v1::SpeechAdaptationInfo* speech_adaptation_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete speech_adaptation_info_;
  }
...
// .google.protobuf.Duration speech_event_time = 8;
inline bool StreamingRecognizeResponse::_internal_has_speech_event_time() const {
  return this != internal_default_instance() && speech_event_time_ != nullptr;
}
inline bool StreamingRecognizeResponse::has_speech_event_time() const {
  return _internal_has_speech_event_time();
}
inline const ::PROTOBUF_NAMESPACE_ID::Duration& StreamingRecognizeResponse::_internal_speech_event_time() const {
  const ::PROTOBUF_NAMESPACE_ID::Duration* p = speech_event_time_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Duration&>(
      ::PROTOBUF_NAMESPACE_ID::_Duration_default_instance_);
}
inline const ::PROTOBUF_NAMESPACE_ID::Duration& StreamingRecognizeResponse::speech_event_time() const {
...
inline void StreamingRecognizeResponse::unsafe_arena_set_allocated_speech_event_time(
    ::PROTOBUF_NAMESPACE_ID::Duration* speech_event_time) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_event_time_);
  }
  speech_event_time_ = speech_event_time;
  if (speech_event_time) {
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognizeResponse::release_speech_event_time() {
  
  ::PROTOBUF_NAMESPACE_ID::Duration* temp = speech_event_time_;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognizeResponse::unsafe_arena_release_speech_event_time() {
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognizeResponse::_internal_mutable_speech_event_time() {
  
  if (speech_event_time_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Duration>(GetArenaForAllocation());
    speech_event_time_ = p;
  }
  return speech_event_time_;
}
inline ::PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognizeResponse::mutable_speech_event_time() {
  ::PROTOBUF_NAMESPACE_ID::Duration* _msg = _internal_mutable_speech_event_time();
  // @@protoc_insertion_point(field_mutable:google.cloud.speech.v1.StreamingRecognizeResponse.speech_event_time)
  return _msg;
}
inline void StreamingRecognizeResponse::set_allocated_speech_event_time(::PROTOBUF_NAMESPACE_ID::Duration* speech_event_time) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_event_time_);
  }
  if (speech_event_time) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(speech_event_time));
    if (message_arena != submessage_arena) {
      speech_event_time = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, speech_event_time, submessage_arena);
    }
...
// .google.cloud.speech.v1.SpeechAdaptationInfo speech_adaptation_info = 9;
inline bool StreamingRecognizeResponse::_internal_has_speech_adaptation_info() const {
  return this != internal_default_instance() && speech_adaptation_info_ != nullptr;
}
...
inline const ::google::cloud::speech::v1::SpeechAdaptationInfo& StreamingRecognizeResponse::speech_adaptation_info() const {
...
inline ::google::cloud::speech::v1::SpeechAdaptationInfo* StreamingRecognizeResponse::mutable_speech_adaptation_info() {
  ::google::cloud::speech::v1::SpeechAdaptationInfo* _msg = _internal_mutable_speech_adaptation_info();
  // @@protoc_insertion_point(field_mutable:google.cloud.speech.v1.StreamingRecognizeResponse.speech_adaptation_info)
  return _msg;
}
inline void StreamingRecognizeResponse::set_allocated_speech_adaptation_info(::google::cloud::speech::v1::SpeechAdaptationInfo* speech_adaptation_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete speech_adaptation_info_;
  }
...
inline void SpeechRecognitionAlternative::set_allocated_transcript(std::string* transcript) {
  ...
  transcript_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), transcript,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (transcript_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
void WordInfo::set_speaker_label(ArgT0&& arg0, ArgT... args) {
 ...
 speaker_label_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& WordInfo::_internal_speaker_label() const {
  return speaker_label_.Get();
}
inline void WordInfo::_internal_set_speaker_label(const std::string& value) {
  
  speaker_label_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* WordInfo::_internal_mutable_speaker_label() {
  
  return speaker_label_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* WordInfo::release_speaker_label() {
  ...
  return speaker_label_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void WordInfo::set_allocated_speaker_label(std::string* speaker_label) {
  ...
  speaker_label_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), speaker_label,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (speaker_label_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SpeechAdaptationInfo::set_timeout_message(ArgT0&& arg0, ArgT... args) {
 
 timeout_message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.speech.v1.SpeechAdaptationInfo.timeout_message)
}
inline std::string* SpeechAdaptationInfo::mutable_timeout_message() {
...
inline const std::string& SpeechAdaptationInfo::_internal_timeout_message() const {
  return timeout_message_.Get();
}
inline void SpeechAdaptationInfo::_internal_set_timeout_message(const std::string& value) {
  
  timeout_message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SpeechAdaptationInfo::_internal_mutable_timeout_message() {
  
  return timeout_message_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SpeechAdaptationInfo::release_timeout_message() {
  ...
  return timeout_message_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void SpeechAdaptationInfo::set_allocated_timeout_message(std::string* timeout_message) {
  if (timeout_message != nullptr) {
    
  } else {
    
  }
  timeout_message_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), timeout_message,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (timeout_message_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_CoreAI3D_2fcloud_5fspeech_2eproto
